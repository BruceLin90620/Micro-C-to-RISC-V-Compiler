...
class MicroCListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MicroCParser#else_stmt.
    def enterElse_stmt(self, ctx:MicroCParser.Else_stmtContext):
        pass

    # Exit a parse tree produced by MicroCParser#else_stmt.
    def exitElse_stmt(self, ctx:MicroCParser.Else_stmtContext):
        pass
